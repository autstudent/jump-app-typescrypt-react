...
The idea of this connection to the backend is to send a JSON or Protobuf object in order to be able to make a set of "jumps" (connection between services) that have been impslemented as microservices in different languages (Golang, Python, Java or Quarkus).
